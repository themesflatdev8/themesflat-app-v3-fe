        ...
        <Card>
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              ...
              >
                <BlockStack gap="100">
                  <Text as="h3" variant="headingMd">Social Media Buttons</Text>
                  <Text as="p" variant="bodyMd" tone="subdued">Boost social proof by displaying buttons linking to your social media profiles, encouraging visitors to connect with your brand</Text>
                </BlockStack>
                <Switch
                  checked={value}
