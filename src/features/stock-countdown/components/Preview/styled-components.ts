...
export const StyledStorefront = styled.div<any>`
  .Msell-Stock-Countdown{
    ...
    justify-content: center;
    gap: 8px;
    background-color: var(--msell-stock-countdown-background-color);
    border: 1px solid var(--msell-stock-countdown-border-color);
    border-radius: 8px;
    margin: 16px auto;
    &[data-template='default'] {
      padding: 8px 16px;
      column-gap: 4px;
      .Msell-Stock-Countdown__Icon {
        svg{
          width: 20px;
          height: 20px;
          margin-bottom: -1px;
    ...
    &__Icon{
      flex-shrink: 0;
      svg{
        fill: var(--msell-stock-countdown-text-color);
      }
    }
    &__Content{
      // display: inline-flex;
      ...
      font-weight: 400;
      line-height: 21px;
      color: var(--msell-stock-countdown-text-color);
      padding: 0;
      margin: 0;
      strong{
        font-size: 14px;
