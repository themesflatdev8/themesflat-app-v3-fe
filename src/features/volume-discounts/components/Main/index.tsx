...
import List from "@/features/volume-discounts/components/List";
import Form from "@/features/volume-discounts/components/Form";

type Props = {
  onRedirect: Function;
};

const MainVolumeDiscounts = ({ onRedirect }: Props) => {
...
export default MainVolumeDiscounts;
